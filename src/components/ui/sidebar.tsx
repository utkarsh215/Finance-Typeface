...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      <div className="lg:hidden fixed top-20 left-4 z-40"> {/* Adjusted top position for navbar */}
        <button
      ...
      <aside
        className={clsx(
          "fixed z-30 lg:static top-16 left-0 h-[calc(100vh-4rem)] w-64 bg-gradient-to-b from-[#0e0f23] to-[#1a1c3b] text-white flex flex-col p-6 shadow-lg border-r border-gray-800 transition-transform duration-300 ease-in-out", /* Adjusted top and height for navbar */
          {
